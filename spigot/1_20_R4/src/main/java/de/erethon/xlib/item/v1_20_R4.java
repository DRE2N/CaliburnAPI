 ...
 */
class v1_20_R4 implements InternalsProvider {
    ...
    public String getTextureValue(ItemStack item) {
        ...
        if (!nmsStack./*has*/b(DataComponents./*PROFILE*/V)) {
            return null;
        }

        ResolvableProfile profile = nmsStack./*get*/a(DataComponents./*PROFILE*/V);
    ...
    public ItemStack setSkullOwner(ItemStack item, Object compound) {
        net.minecraft.world.item.ItemStack nmsStack = CraftItemStack.asNMSCopy(item);
        nmsStack./*set*/a(DataComponents./*PROFILE*/V, (ResolvableProfile) compound);
