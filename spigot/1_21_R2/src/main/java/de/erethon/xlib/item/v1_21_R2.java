 ...
 */
class v1_21_R2 implements InternalsProvider {
    ...
    public String getTextureValue(ItemStack item) {
        ...
        if (!nmsStack./*has*/b(DataComponents./*PROFILE*/ag)) {
            return null;
        }

        ResolvableProfile profile = nmsStack./*get*/a(DataComponents./*PROFILE*/ag);
    ...
    public ItemStack setSkullOwner(ItemStack item, Object compound) {
        net.minecraft.world.item.ItemStack nmsStack = CraftItemStack.asNMSCopy(item);
        nmsStack./*set*/a(DataComponents./*PROFILE*/ag, (ResolvableProfile) compound);
