 ...
 */
class v1_21_R5 implements InternalsProvider {
    ...
    public String getTextureValue(ItemStack item) {
        ...
        if (!nmsStack./*has*/c(DataComponents./*PROFILE*/ak)) {
            return null;
        }

        ResolvableProfile profile = nmsStack./*get*/a(DataComponents./*PROFILE*/ak);
        if (profile == null || profile./*gameProfile*/f() == null) {
            return null;
        }

        Collection<Property> properties = profile./*gameProfile*/g().getProperties().get("textures");
    ...
    public ItemStack setSkullOwner(ItemStack item, Object compound) {
        net.minecraft.world.item.ItemStack nmsStack = CraftItemStack.asNMSCopy(item);
        nmsStack./*set*/a(DataComponents./*PROFILE*/ak, (ResolvableProfile) compound);
