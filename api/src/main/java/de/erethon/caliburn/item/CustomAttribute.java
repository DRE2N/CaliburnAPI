...
/**
 * A class to standardize item modifiers. Many effects can be realized through the {@link de.erethon.caliburn.item.actionhandler action handler API}. Attributes
