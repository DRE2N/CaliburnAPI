...
public class TrackedItemStack {
    ...
    /**
     * For internal use. See {@link CaliburnAPI#wrap(org.bukkit.inventory.ItemStack)} and
     * {@link CaliburnAPI#wrap(de.erethon.caliburn.item.CustomItem, org.bukkit.inventory.ItemStack)}
     *
     * @param api     the api instance
     * @param type    the type
     * @param wrapped the stack to wrap
     */
    public TrackedItemStack(CaliburnAPI api, CustomItem type, ItemStack wrapped) {
        this.type = type;
