...
/**
 * An {@link org.bukkit.inventory.ItemStack} based {@link Button} for {@link de.erethon.xlib.gui.InventoryGUI}s.
 *
...
public class InventoryButton implements Button<InventoryButton, InventoryGUI> {
     ...
     * <p>
     * This is equal to !({@link #isLeftClickLocked()} {@literal &&} {@link #isRightClickLocked()}).
     *
     ...
     * Checks if the button is a representation of an {@link org.bukkit.inventory.ItemStack}.
     * <p>
     * If the button has one or more {@link de.erethon.xlib.gui.context.ContextModifier}s and if it is not a representation of the ItemStack
