...
public class XLib {
     ...
     * Universal deserialization method to deserialize a Bukkit ItemStack.
     *
     * @param object ItemStack, ExItem or {@link de.erethon.xlib.util.SimpleSerialization} String
     * @return the deserialized ItemStack
     */
     ...
     */
    public List<GUI> getGUICache() {
        return new ArrayList<>(guiCache);
    }
     ...
     */
    public <T extends GUI> List<T> getGUICache(Class<T> type) {
        List<T> guis = new ArrayList<>();
        for (GUI gui : guiCache) {
