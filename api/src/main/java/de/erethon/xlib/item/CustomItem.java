...
public class CustomItem extends ExItem {
    ...
    public CustomItem(XLib api, IdentifierType idType, String id, ItemStack item) {
        this.api = api;
        this.idType = idType;
        this.id = id;
        ...
        if (meta instanceof SkullMeta) {
            ...
            if (owner != null) {
                ...
                textureValue = CustomHead.getTextureValue(item);
            }
        }
    ...
    public CustomItem(XLib api, IdentifierType idType, String id, ExItem base) {
        this.api = api;
        this.idType = idType;
        this.id = id;
        name = StringUtil.formatId(id);
    ...
    public static CustomItem deserialize(Map<String, Object> args) {
        ...
        deserialized.api = XLib.getInstance();
    ...
    public void apply(ItemStack itemStack) {
        ...
        if (textureValue != null && skullOwner != null) {
            itemStack = CustomHead.setSkullOwner(itemStack, skullOwner, textureValue);
        }
        if (nbt != null) {
