...
public class VanillaMob extends ExMob {
    ...
    public static final VanillaMob UNKNOWN = new VanillaMob(MC1_8_8, null, "UNKNOWN");

    public static final VanillaMob ITEM = new VanillaMob(MC1_8_8, "Item", "item", "DROPPED_ITEM", 1);
    public static final VanillaMob EXPERIENCE_ORB = new VanillaMob(MC1_8_8, "XPOrb", "xp_orb", "experience_orb", "EXPERIENCE_ORB", 2);
    ...
    public static final VanillaMob EGG = new VanillaMob(MC1_8_8, "ThrownEgg", "egg", "EGG", 7);
    public static final VanillaMob LEASH_KNOT = new VanillaMob(MC1_8_8, "LeashKnot", "leash_knot", "LEASH_HITCH", 8);
    public static final VanillaMob PAINTING = new VanillaMob(MC1_8_8, "Painting", "painting", "PAINTING", 9);
    public static final VanillaMob ARROW = new VanillaMob(MC1_8_8, "Arrow", "arrow", "ARROW", 10);
    public static final VanillaMob SNOWBALL = new VanillaMob(MC1_8_8, "Snowball", "snowball", "SNOWBALL", 11);
    public static final VanillaMob FIREBALL = new VanillaMob(MC1_8_8, "Fireball", "fireball", "FIREBALL", 12);
    public static final VanillaMob SMALL_FIREBALL = new VanillaMob(MC1_8_8, "SmallFireball", "small_fireball", "SMALL_FIREBALL", 13);
    public static final VanillaMob ENDER_PEARL = new VanillaMob(MC1_8_8, "ThrownEnderpearl", "ender_pearl", "ENDER_PEARL", 14);
    public static final VanillaMob EYE_OF_ENDER = new VanillaMob(MC1_8_8, "EyeOfEnderSignal", "eye_of_ender_signal", "eye_of_ender", "ENDER_SIGNAL", 15);
    public static final VanillaMob POTION = new VanillaMob(MC1_8_8, "ThrownPotion", "potion", "SPLASH_POTION", 16);
    public static final VanillaMob EXPERIENCE_BOTTLE = new VanillaMob(MC1_8_8, "ThrownExpBottle", "xp_bottle", "experience_bottle", "THROWN_EXP_BOTTLE", 17);
    public static final VanillaMob ITEM_FRAME = new VanillaMob(MC1_8_8, "ItemFrame", "item_frame", "ITEM_FRAME", 18);
    public static final VanillaMob WITHER_SKULL = new VanillaMob(MC1_8_8, "WitherSkull", "wither_skull", "WITHER_SKULL", 19);
    public static final VanillaMob TNT = new VanillaMob(MC1_8_8, "PrimedTNT", "tnt", "PRIMED_TNT", 20);
    public static final VanillaMob FALLING_BLOCK = new VanillaMob(MC1_8_8, "FallingSand", "falling_block", "FALLING_BLOCK", 21);
    public static final VanillaMob FIREWORK_ROCKET = new VanillaMob(MC1_8_8, "FireworksRocketEntity", "fireworks_rocket", "firework_rocket", "FIREWORK", 22);
    public static final VanillaMob TIPPED_ARROW = new VanillaMob(MC1_8_8, MC1_13, "TippedArrow", "TippedArrow", "tipped_arrow", "TIPPED_ARROW", 23) {
        @Override
    ...
    public static final VanillaMob ARMOR_STAND = new VanillaMob(MC1_8_8, "ArmorStand", "armor_stand", "ARMOR_STAND", 30);
    ...
    public static final VanillaMob COMMAND_BLOCK_MINECART = new VanillaMob(MC1_8_8, "MinecartCommandBlock", "commandblock_minecart", "command_block_minecart", "MINECART_COMMAND", 40);
    public static final VanillaMob BOAT = new VanillaMob(MC1_8_8, "Boat", "boat", "BOAT", 41);
    public static final VanillaMob MINECART = new VanillaMob(MC1_8_8, "MinecartRideable", "minecart", "MINECART", 42);
    public static final VanillaMob CHEST_MINECART = new VanillaMob(MC1_8_8, "MinecartChest", "chest_minecart", "MINECART_CHEST", 43);
    public static final VanillaMob FURNACE_MINECART = new VanillaMob(MC1_8_8, "MinecartFurnace", "furnace_minecart", "MINECART_FURNACE", 44);
    public static final VanillaMob TNT_MINECART = new VanillaMob(MC1_8_8, "MinecartTNT", "tnt_minecart", "MINECART_TNT", 45);
    public static final VanillaMob HOPPER_MINECART = new VanillaMob(MC1_8_8, "MinecartHopper", "hopper_minecart", "MINECART_HOPPER", 46);
    public static final VanillaMob SPAWNER_MINECART = new VanillaMob(MC1_8_8, "MinecartSpawner", "spawner_minecart", "MINECART_MOB_SPAWNER", 47);
    public static final VanillaMob CREEPER = new VanillaMob(MC1_8_8, "Creeper", "creeper", "CREEPER", 50);
    public static final VanillaMob SKELETON = new VanillaMob(MC1_8_8, "Skeleton", "skeleton", "SKELETON", 51);
    public static final VanillaMob SPIDER = new VanillaMob(MC1_8_8, "Spider", "spider", "SPIDER", 52);
    public static final VanillaMob GIANT = new VanillaMob(MC1_8_8, "Giant", "giant", "GIANT", 53);
    public static final VanillaMob ZOMBIE = new VanillaMob(MC1_8_8, "Zombie", "zombie", "ZOMBIE", 54);
    public static final VanillaMob SLIME = new VanillaMob(MC1_8_8, "Slime", "slime", "SLIME", 55);
    public static final VanillaMob GHAST = new VanillaMob(MC1_8_8, "Ghast", "ghast", "GHAST", 56);
    public static final VanillaMob ZOMBIE_PIGMAN = new VanillaMob(MC1_8_8, "PigZombie", "zombie_pigman", "ZOMBIFIED_PIGLIN", 57) {
        @Override
    ...
    public static final VanillaMob ENDERMAN = new VanillaMob(MC1_8_8, "Enderman", "enderman", "ENDERMAN", 58);
    public static final VanillaMob CAVE_SPIDER = new VanillaMob(MC1_8_8, "CaveSpider", "cave_spider", "CAVE_SPIDER", 59);
    public static final VanillaMob SILVERFISH = new VanillaMob(MC1_8_8, "Silverfish", "silverfish", "SILVERFISH", 60);
    public static final VanillaMob BLAZE = new VanillaMob(MC1_8_8, "Blaze", "blaze", "BLAZE", 61);
    public static final VanillaMob MAGMA_CUBE = new VanillaMob(MC1_8_8, "LavaSlime", "magma_cube", "MAGMA_CUBE", 62);
    public static final VanillaMob ENDER_DRAGON = new VanillaMob(MC1_8_8, "EnderDragon", "ender_dragon", "ENDER_DRAGON", 63);
    public static final VanillaMob WITHER = new VanillaMob(MC1_8_8, "WitherBoss", "wither", "WITHER", 64);
    public static final VanillaMob BAT = new VanillaMob(MC1_8_8, "Bat", "bat", "BAT", 65);
    public static final VanillaMob WITCH = new VanillaMob(MC1_8_8, "Witch", "witch", "WITCH", 66);
    public static final VanillaMob ENDERMITE = new VanillaMob(MC1_8_8, "Endermite", "endermite", "ENDERMITE", 67);
    public static final VanillaMob GUARDIAN = new VanillaMob(MC1_8_8, "Guardian", "guardian", "GUARDIAN", 68);
    public static final VanillaMob SHULKER = new VanillaMob(MC1_9, "Shulker", "shulker", "SHULKER", 69);
    public static final VanillaMob PIG = new VanillaMob(MC1_8_8, "Pig", "pig", "PIG", 90);
    public static final VanillaMob SHEEP = new VanillaMob(MC1_8_8, "Sheep", "sheep", "SHEEP", 91);
    public static final VanillaMob COW = new VanillaMob(MC1_8_8, "Cow", "cow", "COW", 92);
    public static final VanillaMob CHICKEN = new VanillaMob(MC1_8_8, "Chicken", "chicken", "CHICKEN", 93);
    public static final VanillaMob SQUID = new VanillaMob(MC1_8_8, "Squid", "squid", "SQUID", 94);
    public static final VanillaMob WOLF = new VanillaMob(MC1_8_8, "Wolf", "wolf", "WOLF", 95);
    public static final VanillaMob MOOSHROOM = new VanillaMob(MC1_8_8, "MushroomCow", "mooshroom", "MUSHROOM_COW", 96);
    public static final VanillaMob SNOW_GOLEM = new VanillaMob(MC1_8_8, "SnowMan", "snowman", "snow_golem", "SNOWMAN", 97);
    public static final VanillaMob OCELOT = new VanillaMob(MC1_8_8, "Ozelot", "ocelot", "OCELOT", 98);
    public static final VanillaMob IRON_GOLEM = new VanillaMob(MC1_8_8, "VillagerGolem", "villager_golem", "iron_golem", "IRON_GOLEM", 99);
    public static final VanillaMob HORSE = new VanillaMob(MC1_8_8, "EntityHorse", "horse", "HORSE", 100);
    public static final VanillaMob RABBIT = new VanillaMob(MC1_8_8, "Rabbit", "rabbit", "RABBIT", 101);
    ...
    public static final VanillaMob VILLAGER = new VanillaMob(MC1_8_8, "Villager", "villager", "VILLAGER", 120);
    public static final VanillaMob END_CRYSTAL = new VanillaMob(MC1_8_8, "EnderCrystal", "ender_crystal", "end_crystal", "ENDER_CRYSTAL", 200);
    ...
    public static final VanillaMob FISHING_HOOK = new VanillaMob(MC1_8_8, "fishing_bobber", "FISHING_HOOK");
    public static final VanillaMob LIGHTNING = new VanillaMob(MC1_8_8, "LightningBolt", "lightning_bolt", "LIGHTNING", -1);
    public static final VanillaMob WEATHER = new VanillaMob(MC1_8_8, MC1_14, "weather", "WEATHER");
    public static final VanillaMob PLAYER = new VanillaMob(MC1_8_8, "Player", "player", "PLAYER", -1);
    public static final VanillaMob COMPLEX_PART = new VanillaMob(MC1_8_8, MC1_14, "complex_part", "COMPLEX_PART");

    public static final SplitMob ELDER_GUARDIAN = new SplitMob(MC1_8_8, GUARDIAN, "elder_guardian", "ELDER_GUARDIAN", 4);
    public static final SplitMob WITHER_SKELETON = new SplitMob(MC1_8_8, SKELETON, "wither_skeleton", "WITHER_SKELETON", 5);
    ...
    public static final SplitMob ZOMBIE_VILLAGER = new SplitMob(MC1_8_8, ZOMBIE, "zombie_villager", "ZOMBIE_VILLAGER", 27);
    public static final SplitMob SKELETON_HORSE = new SplitMob(MC1_8_8, HORSE, "skeleton_horse", "SKELETON_HORSE", 28);
    public static final SplitMob ZOMBIE_HORSE = new SplitMob(MC1_8_8, HORSE, "zombie_horse", "ZOMBIE_HORSE", 29);
    public static final SplitMob DONKEY = new SplitMob(MC1_8_8, HORSE, "donkey", "DONKEY", 31);
    public static final SplitMob MULE = new SplitMob(MC1_8_8, HORSE, "mule", "MULE", 32);
    public static final SplitMob CAT = new SplitMob(MC1_8_8, OCELOT, "cat", "CAT", -1) {
        @Override
        public String getBukkitName() {
