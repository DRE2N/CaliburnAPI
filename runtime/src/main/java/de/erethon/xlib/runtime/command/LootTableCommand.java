...
import de.erethon.xlib.loottable.LootTable.Entry;
...
public class LootTableCommand extends DRECommand {
    ...
    private static final InventoryButton BACK = new InventoryButton(CustomHead.WOODEN_ARROW_LEFT.toItemStack(ChatColor.GOLD + "<="));
    ...
    static {
        ...
        SET_NUMBER_GUI.setCloseListener(e -> {
            ...
            }.runTaskLater(XLibRuntime.getInstance(), 1l);
    ...
    public LootTableCommand(XLibRuntime plugin) {
        api = plugin.getAPI();
    ...
    private static InventoryButton calcButton(BigDecimal d) {
        InventoryButton button = new InventoryButton((d.doubleValue() > 0 ? CustomHead.STONE_ARROW_UP : CustomHead.STONE_ARROW_DOWN)
