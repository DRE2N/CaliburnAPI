...
public class Category<T extends Categorizable> extends Categorizable {
    ...
    public static final Category ARROWS = new Category("arrows", VanillaItem.ARROW, VanillaItem.TIPPED_ARROW, VanillaItem.SPECTRAL_ARROW);
    ...
    public static final Category COALS = new Category("coals", COAL, CHARCOAL);
    public static final Category CORAL_PLANTS = new Category("coral_plants", TUBE_CORAL, BRAIN_CORAL, BUBBLE_CORAL, FIRE_CORAL, HORN_CORAL);
    public static final Category CORALS = new Category("corals", CORAL_PLANTS, TUBE_CORAL_FAN, BRAIN_CORAL_FAN, BUBBLE_CORAL_FAN, FIRE_CORAL_FAN, HORN_CORAL_FAN);
    public static final Category CORAL_BLOCKS = new Category("coral_blocks", TUBE_CORAL_BLOCK, BRAIN_CORAL_BLOCK, BUBBLE_CORAL_BLOCK, FIRE_CORAL_BLOCK, HORN_CORAL_BLOCK);
    public static final Category DARK_OAK_LOGS = new Category("dark_oak_logs", DARK_OAK_WOOD, DARK_OAK_LOG, STRIPPED_DARK_OAK_LOG);
    public static final Category DEAD_CORAL_BLOCKS = new Category("dead_coral_blocks", DEAD_TUBE_CORAL_BLOCK, DEAD_BRAIN_CORAL_BLOCK, DEAD_BUBBLE_CORAL_BLOCK,
            DEAD_FIRE_CORAL_BLOCK, DEAD_HORN_CORAL_BLOCK);
    public static final Category DIRT_LIKE = new Category("dirt_like", DIRT, GRASS_BLOCK, PODZOL, COARSE_DIRT, MYCELIUM);
    public static final Category DRAGON_IMMUNE = new Category("dragon_immune", BARRIER, BEDROCK, END_PORTAL, END_PORTAL_FRAME, END_GATEWAY, COMMAND_BLOCK,
            REPEATING_COMMAND_BLOCK, CHAIN_COMMAND_BLOCK, STRUCTURE_BLOCK, JIGSAW, MOVING_PISTON, OBSIDIAN, END_STONE, IRON_BARS);
    public static final Category FISHES = new Category("fishes", VanillaItem.COD, VanillaItem.COOKED_COD, VanillaItem.SALMON, VanillaItem.COOKED_SALMON,
            VanillaItem.PUFFERFISH, VanillaItem.TROPICAL_FISH);
    public static final Category FLOWER_POTS = new Category("flower_pots", FLOWER_POT, POTTED_POPPY, POTTED_DANDELION, POTTED_OAK_SAPLING, POTTED_SPRUCE_SAPLING,
    ...
    public static final Category IMPERMEABLE = new Category("impermeable", GLASS, WHITE_STAINED_GLASS, ORANGE_STAINED_GLASS, MAGENTA_STAINED_GLASS, LIGHT_BLUE_STAINED_GLASS,
    ...
    public static final Category LEAVES = new Category("leaves", JUNGLE_LEAVES, OAK_LEAVES, SPRUCE_LEAVES, DARK_OAK_LEAVES, ACACIA_LEAVES, BIRCH_LEAVES);
    public static final Category LIVE_CORAL_BLOCKS = new Category("live_coral_blocks", TUBE_CORAL_BLOCK, BRAIN_CORAL_BLOCK, BUBBLE_CORAL_BLOCK, FIRE_CORAL_BLOCK,
            HORN_CORAL_BLOCK);
    public static final Category MUSIC_DISCS = new Category("music_discs", MUSIC_DISC_13, MUSIC_DISC_CAT, MUSIC_DISC_BLOCKS, MUSIC_DISC_CHIRP, MUSIC_DISC_FAR,
    ...
    public static final Category SLABS = new Category("slabs", STONE_SLAB, SMOOTH_STONE_SLAB, STONE_BRICK_SLAB, SANDSTONE_SLAB, ACACIA_SLAB, BIRCH_SLAB,
    ...
    public static final Category SMALL_FLOWERS = new Category("small_flowers", DANDELION, POPPY, BLUE_ORCHID, ALLIUM, AZURE_BLUET, RED_TULIP, ORANGE_TULIP,
    ...
    public static final Category STAIRS = new Category("stairs", OAK_STAIRS, COBBLESTONE_STAIRS, SPRUCE_STAIRS, SANDSTONE_STAIRS, ACACIA_STAIRS, JUNGLE_STAIRS,
    ...
    public static final Category STANDING_SIGNS = new Category("standing_signs", OAK_SIGN, SPRUCE_SIGN, BIRCH_SIGN, ACACIA_SIGN, JUNGLE_SIGN, DARK_OAK_SIGN, SIGN_POST);
    ...
    public static final Category VALID_SPAWN = new Category("valid_spawn", GRASS_BLOCK, PODZOL);
    public static final Category WALL_SIGNS = new Category("wall_signs", OAK_WALL_SIGN, SPRUCE_WALL_SIGN, BIRCH_WALL_SIGN, ACACIA_WALL_SIGN, JUNGLE_WALL_SIGN,
            DARK_OAK_WALL_SIGN);
    public static final Category WALL_CORALS = new Category("wall_corals", TUBE_CORAL_WALL_FAN, BRAIN_CORAL_WALL_FAN, BUBBLE_CORAL_WALL_FAN, FIRE_CORAL_WALL_FAN,
            HORN_CORAL_WALL_FAN);
    public static final Category WALLS = new Category("walls", COBBLESTONE_WALL, MOSSY_COBBLESTONE_WALL, BRICK_WALL, PRISMARINE_WALL, RED_SANDSTONE_WALL,
            ...
            DIORITE_WALL);
    public static final Category WATER = new Category("water", VanillaItem.WATER, FLOWING_WATER);
    ...
    public static final Category WOODEN_TRAPDOORS = new Category("wooden_trapdoors", ACACIA_TRAPDOOR, BIRCH_TRAPDOOR, DARK_OAK_TRAPDOOR, JUNGLE_TRAPDOOR,
    ...
    public static final Category RAIDERS = new Category("raiders", EVOKER, ILLUSIONER, PILLAGER, RAVAGER, VINDICATOR, WITCH);
    public static final Category SKELETONS = new Category("skeletons", SKELETON, STRAY, WITHER_SKELETON);

    // Parents
    public static final Category BAMBOO_PLANTABLE_ON = new Category("bamboo_plantable_on", SAND, DIRT_LIKE, BAMBOO, BAMBOO_SAPLING, GRAVEL);
    ...
    public static final Category ENDERMAN_HOLDABLE = new Category("enderman_holdable", SMALL_FLOWERS, GRASS_BLOCK, DIRT, COARSE_DIRT, PODZOL, VanillaItem.SAND, RED_SAND,
            GRAVEL, BROWN_MUSHROOM, RED_MUSHROOM, VanillaItem.TNT, CACTUS, CLAY, PUMPKIN, CARVED_PUMPKIN, MELON, MYCELIUM, NETHERRACK);
    public static final Category FENCES = new Category("fences", WOODEN_FENCES, NETHER_BRICK_FENCE);
    ...
    public static final Category SIGNS = new Category("signs", STANDING_SIGNS, WALL_SIGNS);
    public static final Category TRAPDOORS = new Category("trapdoors", WOODEN_TRAPDOORS, IRON_TRAPDOOR);
    public static final Category UNDERWATER_BONEMEALS = new Category("underwater_bonemeals", CORALS, WALL_CORALS);

    // Caliburn
    public static final Category SHULKER_BOXES = new Category("shulker_boxes", SHULKER_BOX, WHITE_SHULKER_BOX, ORANGE_SHULKER_BOX, MAGENTA_SHULKER_BOX,
