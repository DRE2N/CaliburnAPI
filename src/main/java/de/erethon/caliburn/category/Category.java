...
public class Category<T extends Categorizable> extends Categorizable {
    ...
    public static final Category ENDERMAN_HOLDABLE = new Category("enderman_holdable", GRASS_BLOCK, DIRT, COARSE_DIRT, PODZOL, VanillaItem.SAND, RED_SAND, GRAVEL, DANDELION,
            ...
            CLAY, PUMPKIN, CARVED_PUMPKIN, MELON, MYCELIUM, NETHERRACK);
    public static final Category FLOWER_POTS = new Category("flower_pots", FLOWER_POT, POTTED_POPPY, POTTED_DANDELION, POTTED_OAK_SAPLING, POTTED_SPRUCE_SAPLING,
            ...
            POTTED_DARK_OAK_SAPLING, POTTED_BLUE_ORCHID, POTTED_ALLIUM, POTTED_AZURE_BLUET, POTTED_RED_TULIP, POTTED_ORANGE_TULIP, POTTED_WHITE_TULIP, POTTED_PINK_TULIP, POTTED_OXEYE_DAISY);
    ...
    public static final Category CORAL_BLOCKS = new Category("coral_blocks", LIVE_CORAL_BLOCKS, DEAD_CORAL_BLOCKS);
